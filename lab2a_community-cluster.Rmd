...
- **Clustering**
  ...
  - **Hierarchical clustering** allows for a non-specific number of clusters. 
    ...
    - **Agglomerative hierarchical clustering**, such as with `diana()`, starts with a small tree and builds up. It is good at identifying small clusters.

    - **Agglomerative hierarchical clustering**, such as with `agnes()`, starts with a big tree and pares down. It is good at identifying large clusters.
