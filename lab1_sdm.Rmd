...
You're also encouraged to use [git](https://git-scm.com/downloads) to version your software, ideally in a [Github](https://github.com) repository.
...
In the end this table is the **data** that feeds into our species distribution model, where:
