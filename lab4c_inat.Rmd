...
1. **2 Species (binary) - neural net**. Draw from 

1. **2 Species (binary) - convolutional neural net**.  

1. **10 Species (multiclass) - neural net**.  

1. **10 Species (multiclass) - convolutional neural net**.  
