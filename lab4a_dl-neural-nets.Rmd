---
title: "Lab 4a. Deep Learning - Neural Networks"
editor_options: 
...
_Let's look at the first 4 training images and their labels._
...
I forked [fchollet/deep-learning-with-python-notebooks](https://github.com/fchollet/deep-learning-with-python-notebooks) into
[bbest/deep-learning-with-python-notebooks](https://github.com/bbest/deep-learning-with-python-notebooks) and updated the [first_edition](https://github.com/bbest/deep-learning-with-python-notebooks/tree/master/first_edition) folder with all the minor tweaks to work with the current versions of `keras` and `tensorflow`. Note that these were run from `taylor.bren.ucsb.edu` which does not have a GPU so error messages about missing GPU/NVIDIA/CUDA software appear, but still run through the CPU.

You can then download the first notebook, i.e. [2.1-a-first-look-at-a-neural-network.ipynb](https://github.com/bbest/deep-learning-with-python-notebooks/raw/master/first_edition/2.1-a-first-look-at-a-neural-network.ipynb) by right-clicking to Save link as... locally, or perhaps if navigating from the Github folder similarly right-clicking on Raw to Save link as...
