...
After you start a Then you can start a new JupyterLab Session and Python 3 (ipykernel) Notebook. Then upload the notebook file (`*.ipynb`) you previously downloaded.
